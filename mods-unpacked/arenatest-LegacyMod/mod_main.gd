...
const MOD_DIR := "arenatest-LegacyMod" # Name of the directory that this file is in
const LOG_NAME := "arenatest-LegacyMod:Main" # Full ID of the mod (AuthorName-ModName)
...
func _init() -> void:
	...
	# Add translations (dont need those)
	#add_translations()
